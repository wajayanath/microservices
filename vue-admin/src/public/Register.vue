<template>
    <form class="form-signin">
        ...
        <input type="passwordConfirm" id="inputPassword" class="form-control" placeholder="Password" required>

        <label for="inputPassword" class="sr-only">Password Confirm</label>
        <input type="passwordConfirm" id="inputPassword" class="form-control" placeholder="Password Confirm" required>
